...
- **PATIENT:** own profile/appointments + availability read + clinic register + authenticated clinic browse + mobile booking (`Requested`). Authoritative Mobile MVP: `Docs/mvp-patient-scope.md` (**approved** 2026-07-25; **PM-0…PM-5 delivered**; PM-6…PM-8 pending). PM-1: foreign patient profile `404`; 2-hour cancel/reschedule cutoff. Remaining: My Appointments mobile UX (PM-6+). No medical notes / staff ops / confirm / check-in.
