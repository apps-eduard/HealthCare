...
- **PATIENT:** own profile/appointments + availability read + clinic register; no staff ops. Authoritative Mobile MVP: `Docs/mvp-patient-scope.md` (**approved** 2026-07-25; PM-0 docs only — implementation PM-1…PM-8). Approved gaps: authenticated clinic browse (PM-4); cross-patient profile concealment target `404` (PM-1); 2-hour cancel/reschedule cutoff (PM-1). No medical notes / staff ops / confirm / check-in.
