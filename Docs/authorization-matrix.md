...
- **PATIENT:** own profile/appointments + availability read + clinic register + authenticated clinic browse + mobile booking (`Requested`) + My Appointments cancel/reschedule (2-hour cutoff). Authoritative Mobile MVP: `Docs/mvp-patient-scope.md` (**approved** 2026-07-25; **PM-0…PM-6 delivered**; PM-7…PM-8 pending). PM-1: foreign patient profile `404`; 2-hour cancel/reschedule cutoff. Remaining: Patient security matrix (PM-7) + E2E (PM-8). No medical notes / staff ops / confirm / check-in.
