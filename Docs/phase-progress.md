...
**Current focus:** Doctor Web MVP DR-3 (not started) — DR-1 and DR-2 delivered; scope approved 2026-07-25
...
**Temporary known gaps after DR-2:** appointment ownership (DR-4), Model A patients (DR-5; Patients nav hidden for Doctor), medical-note ownership/UI (DR-6).
