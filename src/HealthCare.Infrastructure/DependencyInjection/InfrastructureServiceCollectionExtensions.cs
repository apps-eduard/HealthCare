...
public static class InfrastructureServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IPatientClinicDirectoryService, PatientClinicDirectoryService>();
        ...
        services.AddScoped<IMedicalNoteAccessService, MedicalNoteAccessService>();
        services.AddScoped<IMedicalNoteAuditStore, MedicalNoteAuditStore>();
