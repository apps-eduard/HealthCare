...
{
    /// <inheritdoc />
    public partial class AddIdentityAndCoreEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StaffMembers_Role", "\"Role\" IN ('PLATFORM_ADMIN', 'ORGANIZATION_ADMIN', 'CLINIC_ADMIN', 'DOCTOR', 'NURSE', 'RECEPTIONIST')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clinics_OrganizationId",
                schema: "public",
                table: "Clinics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_ClinicId",
                schema: "public",
                table: "StaffMembers",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_ClinicId_IsActive",
                schema: "public",
                table: "StaffMembers",
