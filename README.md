...
- [Patient MVP scope](Docs/mvp-patient-scope.md) *(approved — **PM-0…PM-3**; PM-4…PM-8 not started)*
...
│   ├── HealthCare.Mobile/           # Patient MAUI Blazor Hybrid (PM-2/PM-3: foundation + auth/profile)
