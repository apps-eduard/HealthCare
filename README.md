...
- [Patient MVP scope](Docs/mvp-patient-scope.md) *(approved — **PM-0…PM-4**; PM-5…PM-8 not started)*
...
│   ├── HealthCare.Mobile/           # Patient MAUI Blazor Hybrid (PM-2…PM-4: foundation, auth/profile, discovery)
