...
- [Patient MVP scope](Docs/mvp-patient-scope.md) *(approved — **PM-0…PM-5**; PM-6…PM-8 not started)*
...
│   ├── HealthCare.Mobile/           # Patient MAUI Blazor Hybrid (PM-2…PM-5: foundation through booking)
